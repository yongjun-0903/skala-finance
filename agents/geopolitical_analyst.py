...
class GeopoliticalAnalyst:
    ...
    def analyze_geopolitics(self, query_data):
        ...
        # 트럼프 영향 분석
        if query_data.get("geopolitical_analysis", False) or "트럼프" in query_data.get("raw_query", "").lower():
            ...
            industry_impacts = {}
            key_industries = ["반도체", "자동차", "금융", "철강", "통신"]
